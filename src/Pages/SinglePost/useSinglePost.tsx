...
export const useSinglePost = () => {
  ...
  const [selectedPortfolioSlug, setSelectedPortfolioSlug] = useState(id);
  ...
  const {
    ...
    queryFn: () => PortfolioRepository.fetchSinglePortfolio(id as string),
    staleTime: 10000,
    enabled: !!id,
  });
  ...
  return {
    ...
    notFound: !portfolioLoadingState && !finalPortfolioData,
    ContentRef,
  };
};
